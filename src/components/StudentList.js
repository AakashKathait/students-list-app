    ...
    handleTagSearch(e) {
        ...
        this.setState(st => {
            st.students.forEach(student => {
                let joinedTags = student.tags.join('')
                ...
                if(st.tagSearch === "" && st.nameSearch === "") {
                    ...
                    student.tags.forEach(tag => {
                        if(tag) {
                            ...
                            if(joinedTags.includes(st.tagSearch) && studentName.includes(st.nameSearch)) {
                            Object.assign(student, {available: true})
                            }else Object.assign(student, {available: false})
                        }
                    })
            ...
            <div className="list">
                <div className="search-container">
                    <div className="name-search-container">
                        <input onChange={this.handleNameSearch} type="search" placeholder="Search by name" className="search-by-name" />
                    </div>         
                </div>
                <div className="search-container">
                    <div className="tag-search-container">
                        <input onChange={this.handleTagSearch} type="search" placeholder="Search by tag" className="search-by-tag" />
                    </div>         
                </div>
